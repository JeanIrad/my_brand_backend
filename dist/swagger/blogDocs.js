...
var BlogDocs = {
    "/api/blogs": {
        get: __assign({ summary: "Get a list of all blogs" }, listBlogs),
        post: __assign({ summary: "Create a new blog post" }, createBlog),
    },
    "/api/blogs/{id}": {
        get: __assign({ summary: "Get a single blog post by ID" }, getOneBlogById),
        put: __assign({ summary: "Update an existing blog post" }, putBlog),
        delete: __assign({ summary: "Delete an existing blog post" }, deleteBlog),
    },
};
